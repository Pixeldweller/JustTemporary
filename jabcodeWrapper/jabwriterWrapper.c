...
struct jabDTO {
   ...
   int symbol_versions_x;
   int symbol_versions_y;
   //jab_vector2d* 	symbol_versions;
   int 		symbol_versions_number;
   int* 		symbol_ecc_levels;
...
__declspec(dllexport) const char* __stdcall writeToByteArray(struct jabDTO* ptrDTO, struct jab_bitmap_mod* ptrBitmap) {
	//printUsage();
